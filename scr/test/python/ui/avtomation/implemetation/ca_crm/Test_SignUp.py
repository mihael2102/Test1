...
from scr.test.python.ui.avtomation.utils.preconditions.sign_up.BrandSignUpPrecondition import BrandSignUpPrecondition
...
class SignUp(BaseTest):
    ...
    def test_check_sign_up(self):
        ...
        assert crm_client_profile.get_status_client() == "Live"
