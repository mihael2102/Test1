...
path_to_file = "C://Users//Administrator//.jenkins//workspace//Regression Brand//src//main//python//utils//config//Config.py"

url_client_area = "http://forexstaging.pandatradingsystems.com"
new_url_crm = "https://forexstaging.ptscrm.com"
