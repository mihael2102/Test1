...
class LeadPrecondition(object):
    ...
    def create_lead(self):
        ...
        CRMHomePage().open_lead_module() \
            .open_create_lead_module().perform_create_lead(LeadsModuleConstants.SECOND_NAME_LEAD,
    ...
    def create_three_leads(self):
        ...
        CRMHomePage().open_lead_module() \
            ...
            Config.data.get_data_lead_info(LeadsModuleConstants.SECOND_LEAD_INFO,
                                           LeadsModuleConstants.FIRST_DESCRIPTION),
        ...
        CRMHomePage().open_lead_module() \
            ...
            Config.data.get_data_lead_info(LeadsModuleConstants.THIRD_LEAD_INFO,
                                           LeadsModuleConstants.FIRST_DESCRIPTION),
