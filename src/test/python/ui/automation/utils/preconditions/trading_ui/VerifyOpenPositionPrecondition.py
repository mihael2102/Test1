...
from src.main.python.ui.crm.model.pages.trading_ui.TradingDetailsPage import TradingDetailsPage


class VerifyOpenPositionPrecondition(object):
    ...
    def verify_open_position_crm_ui(self):
        ...
        open_orders_data = TradingDetailsPage(self.driver) \
            .display_open_trades()\
