...
class WorkflowsPrecondition(object):
    ...
    def create_workflows(self):
        ...
        if global_var.current_brand_name == "ptbanc" or \
                ...
                global_var.current_brand_name == "brokerxp" or \
                global_var.current_brand_name == "fxpmarkets" or \
                global_var.current_brand_name == "kayafx" or \
                global_var.current_brand_name == "forex_staging":
            WorkflowsPage(self.driver)\
                .select_status(WorkflowsConstants.STATUS_B_TEST)
        else:
            WorkflowsPage(self.driver)\
                .select_status(WorkflowsConstants.STATUS_TEST)
    ...
    def check_workflow_by_status(self):
        ...
        CRMHomePage(self.driver)\
            .open_crm_configuration(CRMConstants.CRM_CONFIGURATION)
        workflow_module = CRMConfigurationPage(self.driver)\
            .check_workflows_loaded()
        ...
        if global_var.current_brand_name == "q8" or \
            ...
            ClientProfilePage(self.driver)\
                .change_client_status_with_pencil(WorkflowsConstants.STATUS_TEST)
        else:
            ClientProfilePage(self.driver)\
                .change_client_status_with_pencil(WorkflowsConstants.STATUS_B_TEST)
        CRMHomePage(self.driver)\
            .refresh_page()
        sleep(3)
        CRMHomePage(self.driver)\
        ...
        address = ClientProfilePage(self.driver)\
            .get_address_text()
