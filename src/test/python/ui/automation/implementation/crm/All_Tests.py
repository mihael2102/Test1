...
class AllTest(BaseTest):
    ...
    #             # i += 1
    #             # if i == 1:
    #             #     log_dir = 'D:\\video'  # путь куда положить файл с записью
    #             #     CORE_DIR = 'D:\\ffmpeg-20181212-32601fb-win64-static (1)\\ffmpeg-20181212-32601fb-win64-static\\'  # путь где лежит ffmpeg.exe
    #             #     video_file = join(log_dir, 'video_' + "test" + '.flv')
