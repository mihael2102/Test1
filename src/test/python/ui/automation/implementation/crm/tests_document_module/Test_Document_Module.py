...
class CreateDocument(BaseTest):
    ...
    def test_create_document(self):
        ...
        assert document_type == Config.data.get_data_document_crm(DocumentModuleConstants.DOCUMENTS_MODULE_TABS,
                                                                  DocumentModuleConstants.FIRST_DOCUMENT_TYPE)
        assert document_status == Config.data.get_data_document_crm(DocumentModuleConstants.DOCUMENTS_MODULE_TABS,
                                                                    DocumentModuleConstants.FIRST_STATUS)
        assert document_comment == Config.data.get_data_document_crm(DocumentModuleConstants.DOCUMENTS_MODULE_TABS,
                                                                     DocumentModuleConstants.COMMENTS)
