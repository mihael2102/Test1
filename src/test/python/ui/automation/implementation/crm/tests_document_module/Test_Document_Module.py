...
class CreateDocument(BaseTest):
    ...
    def test_create_document(self):
        ...
        document_module.open_create_document_module().perform_create_document(
            Config.data.get_data_document_crm(DocumentModuleConstants.FILTER_INFO,
        ...
        assert document_type == Config.data.get_data_document_crm(DocumentModuleConstants.FILTER_INFO,
                                                                  DocumentModuleConstants.FIRST_DOCUMENT_TYPE)
        assert document_status == Config.data.get_data_document_crm(DocumentModuleConstants.FILTER_INFO,
                                                                    DocumentModuleConstants.FIRST_STATUS)
        assert document_comment == Config.data.get_data_document_crm(DocumentModuleConstants.FILTER_INFO,
                                                                     DocumentModuleConstants.COMMENTS)
