...
class MassSmsTaskModule(BaseTest):
    ...
    def test_perform_mass_sms_task_module(self):
        ...
        message = task_module.find_event_by_subject(
            CRMTaskModuleConstants.FIRST_SUBJECT).open_first_client_profile() \
            .perform_scroll_down() \
            .open_sms_tab() \
        ...
        second_message = task_module.find_event_by_subject(
            CRMTaskModuleConstants.FIRST_SUBJECT).open_second_client_profile() \
            .perform_scroll_down() \
            .open_sms_view_module(CRMConstants.MESSAGE_MASS_SMS) \
            .get_sms_text()
        ...
        third_message = task_module.find_event_by_subject(
            CRMTaskModuleConstants.FIRST_SUBJECT).open_third_client_profile() \
            .perform_scroll_down() \
            .open_sms_view_module(CRMConstants.MESSAGE_MASS_SMS) \
            .get_sms_text()
