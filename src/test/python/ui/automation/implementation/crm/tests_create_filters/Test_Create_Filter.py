            ...
            try:
                ...
                if (global_var.current_brand_name == "ogtrade"):
                    assert self.config.get_data_lead_info_from_json(
                        LeadsModuleConstants.EIGHT_COLUMN_STREET) == eighth_name_column
    ...
    def test_create_filter_help_desk(self):
        try:
            ...
            try:
                ...
                assert HelpDeskConstants.ASSIGNED_TO_TYPE == fourth_name_column
                assert HelpDeskConstants.STATUS == fifth_name_column
                if (global_var.current_brand_name == "fm-fx") or (global_var.current_brand_name == "gmo") or (
                        global_var.current_brand_name == "gmo-dev") or \
                        (global_var.current_brand_name == "oinvestsa") or (global_var.current_brand_name == "itrader") or (
