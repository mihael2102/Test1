...
from src.test.python.ui.automation.utils.preconditions.affiliates.Affiliates_Precondition_UI import \
    AffiliatesPreconditionUI
...
class TestAffiliateModuleUI(BaseTest):
    ...
    def test_create_delete_affiliate_ui(self):
        AffiliatesPreconditionUI(self.driver, self.config).create_delete_affiliate_ui()
