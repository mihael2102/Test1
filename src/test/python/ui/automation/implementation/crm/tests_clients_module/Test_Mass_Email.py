...
class SendEmailTestCRM(BaseTest):
    ...
    def test_make_send_email(self):
        crm_clients_module_page = CRMLoginPage() \
            ...
            .perform_searching_by_email(Config.data.get_data_client(TestDataConstants.FIRST_EMAIL)) \
            .click_search_button()
        ...
        email_home_page = EmailHomePage().open_second_tab_page(Config.url_gmail) \
            ...
            .click_first_next() \
            .set_password_email(Config.data.get_data_client(EmailConstants.FIRST_EMAIL_PASSWORD)) \
            .click_second_next()
