...
class SearchingClientsTestCRM(BaseTest):
    ...
    def test_make_searching_client_module(self):
        ...
        if (global_var.current_brand_name == "xtraderfx") or (global_var.current_brand_name == "royal_cfds") or (global_var.current_brand_name == "rimarkets"):
                sleep(15)
        ...
        elif (global_var.current_brand_name == "q8") or (global_var.current_brand_name == "itrader"):
                ClientsPage(self.driver).perform_searching(
