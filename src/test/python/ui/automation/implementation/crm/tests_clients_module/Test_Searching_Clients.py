...
class SearchingClientsTestCRM(BaseTest):
    ...
    def test_search_client_magnifying_glass(self):
        ...
        crm_id = ClientsModulePage(self.driver)\
            .get_client_crm_id_list_view(ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
        client_status = CRMBaseMethodsPage(self.driver)\
            .get_data_from_list_view_vtiger(column=ClientsModuleConstantsUI.COLUMN_CLIENT_STATUS,
                                            row=ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
        email = CRMBaseMethodsPage(self.driver)\
            .get_data_from_list_view_vtiger(column=ClientsModuleConstantsUI.COLUMN_EMAIL,
                                            row=ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
        client_name = CRMBaseMethodsPage(self.driver)\
            .get_data_from_list_view_vtiger(column=ClientsModuleConstantsUI.COLUMN_CLIENT_NAME,
                                            row=ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
        assigned_to = CRMBaseMethodsPage(self.driver) \
            .get_data_from_list_view_vtiger(column=ClientsModuleConstantsUI.COLUMN_ASSIGNED_TO,
                                            row=ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
        country = CRMBaseMethodsPage(self.driver) \
            .get_data_from_list_view_vtiger(column=ClientsModuleConstantsUI.COLUMN_COUNTRY,
                                            row=ClientsModuleConstantsUI.ROW_NUMBER_FOR_DATA_SEARCHING_1)
