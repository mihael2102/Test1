...
class ChangePasswordTestCA(BaseTest):
    ...
    def test_change_password_from_ca(self):
        ...
        client_details_page = CaAccountDetails().open_change_password_tab() \
            .perform_change_password(
            Config.data.get_data_client(TestDataConstants.CLIENT_ONE, TestDataConstants.PASSWORD),
            Config.data.get_data_client(TestDataConstants.CLIENT_ONE, TestDataConstants.NEW_PASSWORD))
        ...
        BrandLoginForm().set_fields(Config.data.get_data_client(TestDataConstants.CLIENT_ONE, TestDataConstants.E_MAIL),
