...
class CaWithdrawSecondStepRequest(BrandBasePage):
    ...
    def perform_withdraw_second_step_request(self):
        self.set_card_number_field(Config.data.get_data_first_client(TestDataConstants.CREDIT_CARD))
        self.set_expiry_date(Config.data.get_data_first_client(TestDataConstants.EXPIRY_DATE))
        self.set_year_field(Config.data.get_data_first_client(TestDataConstants.EXPIRY_YEAR))
        self.set_cvc_field(Config.data.get_data_first_client(TestDataConstants.CVC))
        self.select_withdraw_reason(Config.data.get_data_first_client(TestDataConstants.WITHDRAWAL_REASON))
        self.submit_button()
