...
class BrandFinancialInformationForm(BrandBasePage):
    ...
    def select_annual_income(self, annual_income):
        ...
        select.click()
        Logging().reportDebugStep(self, "The annual income was set: " + annual_income)
        return BrandFinancialInformationForm()

    def select_employee_status(self, employment_status):
        drop_down_employee_status = self.driver.find_element(By.XPATH, "//custom-select[@name='employmentStatus']")
        drop_down_employee_status.click()
        ...
        select.click()
        Logging().reportDebugStep(self, "The employment status was set: " + employment_status)
        return BrandFinancialInformationForm()
    ...
    def select_risk(self, investment_knowledge):
        ...
        select.click()
        Logging().reportDebugStep(self, "The investment knowledge was set: " + investment_knowledge)
        return BrandFinancialInformationForm()
    ...
    def select_average_trade(self, atv):
        ...
        select.click()
        Logging().reportDebugStep(self, "The iaverage_trade was set: " + atv)
        return BrandFinancialInformationForm()
    ...
    def select_saving_investment(self, saving_investment):
        ...
        select.click()
        Logging().reportDebugStep(self, "The saving_investment was set: " + saving_investment)
        return BrandFinancialInformationForm()
    ...
    def enter_next_button(self):
        ...
        next_button.click()
        Logging().reportDebugStep(self, "Click next button was set")
