...
class DataProviders(object):
    ...
    def get_data_client(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Regression Brand/src/test/python/resources/test-data/client-information.json')
        conn_string = json.load(connection_file)
        return conn_string[TestDataConstants.CLIENT_ONE][value]

    def get_data_document_crm(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Regression Brand/src/test/python/resources/test-data/crm-information.json')
        conn_string = json.load(connection_file)
    ...
    def get_data_client_information_update_ca(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Regression Brand/src/test/python/resources/test-data/client-information-update_ca.json')
        conn_string = json.load(connection_file)
        return conn_string[CAClientUpdate.CLIENT_UPDATE_CA][value]

    def get_data_mass_edit(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Regression Brand/src/test/python/resources/test-data/tasks-module.json')
        conn_string = json.load(connection_file)
    ...
    def get_data_lead_info(self, key, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Regression Brand/src/test/python/resources/test-data/leads-information.json')
        conn_string = json.load(connection_file)
