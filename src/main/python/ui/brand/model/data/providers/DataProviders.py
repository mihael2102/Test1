...
class DataProviders(object):
    ...
    def get_crm_data(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Smoke New Forex Staging/src/test/python/resources/test-data/crm.json')
        conn_string = json.load(connection_file)
    ...
    def get_data_mass_edit(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Smoke New Forex Staging/src/test/python/resources/test-data/mass_edit_information.json')
        conn_string = json.load(connection_file)
        return conn_string[CRMMassEditConstants.MASS_EDIT_CLIENT_MODULE][value]

    def get_data_mass_sms(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Smoke New Forex Staging/src/test/python/resources/test-data/mass_sms_information.json')
        conn_string = json.load(connection_file)
        return conn_string[CRMMassEditConstants.MASS_SMS_CLIENT_MODULE][value]

    def get_data_task_module(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/Smoke New Forex Staging/src/test/python/resources/test-data/crm_information.json')
        conn_string = json.load(connection_file)
