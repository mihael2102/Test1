class WithdrawActualResult(object):
    ...
    def print_first_actual_result(self, withdraw_status, account):
        print(
            '\n' + "Actual result: " + "Withdraw was performed successfully from   " + account + " the withdraw_ca status is " +
            withdraw_status + " status" + '\n')

    def print_second_actual_result(self, withdraw_cancel_request, account):
        print(
            '\n' + "Actual result: " + "Withdraw  cancel was perform successfully for   " + account + " the withdraw_ca status is " +
