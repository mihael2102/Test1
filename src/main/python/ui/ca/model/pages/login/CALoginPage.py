...
class CALoginPage(CRMBasePage):
    ...
    def select_country(self, country):
        ...
        country_item = self.driver.find_element_by_xpath(global_var.get_xpath_for_current_brand_element(
    ...
    def get_client_name(self, user_name):
        ...
        try:
            ...
            self.refresh_page()
            sleep(1)
            verify_client = super().wait_load_element("//a[contains(text(), '%s')]" % user_name, timeout=35)
            client = verify_client.text
