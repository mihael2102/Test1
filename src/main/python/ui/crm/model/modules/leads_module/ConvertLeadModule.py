...
class ConvertLeadModule(CRMBasePage):
    ...
    def set_source_name(self, sourve_name):
        description_field = super().wait_load_element("//input[@name='account[SourceName]']")
        description_field.clear()
        description_field.send_keys(sourve_name)
        Logging().reportDebugStep(self, "The state was set: " + sourve_name)
        return ConvertLeadModule()
    ...
    def click_submit(self):
        task_module = super().wait_load_element("//div[@class='modal-footer new-modal-footer']//button[@type='submit']")
        task_module.click()
