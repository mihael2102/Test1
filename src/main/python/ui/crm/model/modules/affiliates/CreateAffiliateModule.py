...
class CreateAffiliateModule(CRMBasePage):
    ...
    def set_allowed_methods(self, allowed_methods_1, allowed_methods_2, allowed_methods_3, allowed_methods_4,
                            allowed_methods_5):
        allowed_pick_list = self.driver.find_element(By.ID,
        ...
        first_allowed_element = self.driver.find_element(By.ID,
        ...
        second_allowed_element = self.driver.find_element(By.ID,
        ...
        third_allowed_element = self.driver.find_element(By.ID,
        ...
        fourth_allowed_element = self.driver.find_element(By.ID,
        ...
        fifth_allowed_element = self.driver.find_element(By.ID,
