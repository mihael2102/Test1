class TestDataConstants(object):
    ...
    TRADING_LEVERAGE_400 = "leverage_400"
    ...
    TRADING_ACCOUNT_DEMO_LEVERAGE_400 = "leverage_400"
    ...
    TRADING_GROUP_LIVE_FINMARKET = "group_finmarket"
