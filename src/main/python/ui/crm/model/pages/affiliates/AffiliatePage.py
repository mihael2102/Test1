...
class AffiliatePage(CRMBasePage):
    ...
    def select_allowed_methods(self, method):
        ...
        sleep(1)
        methods = super().wait_load_element("/html/body/bs-modal[2]/div/div/form/bs-modal-body/div/div[4]/div[2]/filter-multi-select/div/div[2]/span[contains(text(),'%s')]" % method)
        sleep(1)
        methods.click()
    ...
    def select_blocked_country(self, country):
        ...
        sleep(1)
        countrys = super().wait_load_element("/html/body/bs-modal[2]/div/div/form/bs-modal-body/div/div[5]/div[2]/filter-multi-select/div/div[2]/span[contains(text(),'%s')]" % country)
        sleep(1)
        countrys.click()
