...
class HelpDeskEditPage(CRMBasePage):
    ...
    def set_title(self, tittle):
        ...
        Logging().reportDebugStep(self, "The tittle was edited: " + tittle)
    ...
    def select_related_to(self, related_to):
        ...
        search_button.click()
        Logging().reportDebugStep(self, "The related_to edited: " + related_to)
        return HelpDeskEditPage()
    ...
    def click_exist_client_name(self, client_name):
        ...
        Logging().reportDebugStep(self, "The client name was edited: " + client_name)
        return HelpDeskEditPage()
    ...
    def set_assigned_to(self, assigned_to):
        ...
        Logging().reportDebugStep(self, "The assigned_to was edited: ")
        return HelpDeskEditPage()
    ...
    def set_ticket_source(self, ticket_source):
        ...
        Logging().reportDebugStep(self, "The ticket source was edited: " + ticket_source)
        return HelpDeskEditPage()
    ...
    def set_description(self, description):
        ...
        Logging().reportDebugStep(self, "The description was edited: " + description)
        return HelpDeskEditPage()
    ...
    def set_notes(self, notes):
        ...
        Logging().reportDebugStep(self, "The notes was edited: " + notes)
        return HelpDeskEditPage()
