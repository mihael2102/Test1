...
class HelpDeskDetailViewPage(CRMBasePage):
    ...
    def get_category_text(self):
        ...
        Logging().reportDebugStep(self, "Get category of ticket: " + category.text)
        return category.text

    def get_ticket_status_text(self):
        status = super().wait_load_element("//td[@id='mouseArea_Status']")
        Logging().reportDebugStep(self, "Get status of ticket: " + status.text)
        return status.text
    ...
    def get_subject_tittle(self):
        ...
        Logging().reportDebugStep(self, "Get subject: " + new_subject_tittle)
    ...
    def get_description_text(self):
        ...
        Logging().reportDebugStep(self, "Get description:  " + new_description)
    ...
    def get_assigned_to_text(self):
        ...
        Logging().reportDebugStep(self, "Get Assigned To: " + new_assigned)
        return new_assigned

    def get_ticket_source(self):
        ticket_source = super().wait_load_element("//td[contains(text(),'Ticket Source')]//following-sibling::td[1]")
        ticket_source = ticket_source.text.strip()
        Logging().reportDebugStep(self, "Get ticket source: " + ticket_source)
    ...
    def get_notes_text(self):
        ...
        Logging().reportDebugStep(self, "Get notes: " + new_notes)
        return new_notes
