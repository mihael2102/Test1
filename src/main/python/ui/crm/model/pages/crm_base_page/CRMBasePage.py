...
class CRMBasePage(object):
    ...
    def wait_element_to_be_clickable(self, element, timeout=70):
        return WebDriverWait(self.driver, timeout).until(
    ...
    def perform_scroll_right(self, parameter=0):
    ...
    def click_close(self):
        button = self.wait_load_element("//div[@class='bootstrap-dialog-footer']/div/button[contains(text(), 'Close')]")
    ...
    def wait_updating_to_finish(self, time):
