...
class CRMConfigurationPage(CRMBasePage):
    ...
    def check_brand_configuration_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'Brand Configuration')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no Brand Configuration module")
            return CRMConfigurationPage(self.driver)

    def check_sms_configuration_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'SMS Configuration')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no SMS Configuration module")
            return CRMConfigurationPage(self.driver)

    def check_smtp_configuration_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'SMTP Configuration')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no SMTP Configuration module")
            return CRMConfigurationPage(self.driver)

    def check_minimum_deposit_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'Minimum Deposit')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no Minimum Deposit module")
            return CRMConfigurationPage(self.driver)
    ...
    def check_click2call_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'Click2Call Configuration')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no Click2Call module")
            return CRMConfigurationPage(self.driver)

    def check_referral_configuration_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'Referral Configuration')]")
            ...
            pass
            Logging().reportDebugStep(self, "There is no Referral Configuration module")
            return CRMConfigurationPage(self.driver)
    ...
    def check_workflows_loaded(self):
        ...
        try:
            ...
            Logging().reportDebugStep(self, "There is no Workflows module")
            return False
    ...
    def check_list_row_colors_loaded(self):
        sleep(1)
        try:
            self.driver.find_element_by_xpath("//a[contains(text(),'List Row Colors')]")
            brand_configuration_btn = super().wait_load_element("//a[contains(text(),'List Row Colors')]")
            brand_configuration_btn.click()
            self.driver.find_element_by_xpath("//div[contains(text(),'List Row Colors')]")
            Logging().reportDebugStep(self, "List Row Colors is loaded")
            return CRMConfigurationPage(self.driver)
        except (TimeoutException, NoSuchElementException):
            pass
            Logging().reportDebugStep(self, "There is no List Row Colors module")
            return CRMConfigurationPage(self.driver)
