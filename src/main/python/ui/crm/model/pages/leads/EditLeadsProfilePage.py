...
class EditLeadsProfilePage(CRMBasePage):
    ...
    def perform_edit_lead_without_reff_and_sourse(self, first_name, last_name, mobile, fax, email, secondary_email,
                            language, panda_partner_id, street, postal_code, country, description,
                            phone, tittle, lead_status, assigned_to, source_name, brand, po_box,
                            city, state):
    ...
    def perform_edit_lead_without_reff(self, first_name, last_name, mobile, fax, email, secondary_email,
                            language, panda_partner_id, street, postal_code, country, description,
                            phone, tittle, lead_source, lead_status, assigned_to, source_name, brand, po_box,
                            city, state):
