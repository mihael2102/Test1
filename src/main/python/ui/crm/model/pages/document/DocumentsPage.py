...
class DocumentsPage(CRMBasePage):
    ...
    # click on the title Document No in list view for sorting
    def click_document_no(self):
        document_no = super().wait_element_to_be_clickable("//a[text()='Document No']", timeout=55)
        document_no.click()
