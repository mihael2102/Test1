...
class DataProviders(object):
    ...
    def get_data_api_client_information(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/%s/src/test/python/resources/test-data/api_information.json' % Config.test)
        conn_string = json.load(connection_file)
    ...
    def get_data_management_report_module(self, value):
        connection_file = open(
            'C:/Users/Administrator/.jenkins/workspace/%s/src/test/python/resources/test-data/reports-information.json' % Config.test)
        conn_string = json.load(connection_file)
