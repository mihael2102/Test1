...
class ExcelWriter:
    ...
    def write_test_results(self, brands, tests, results):
        ...
        for brand in brands:
            ...
            for test in tests:
                ...
                elif ("does not exist" in test_result) or ("There are no" in test_result) or \
    ...
    def steps_for_test(self, test):
        ...
        if self.get_test_pretty_name_new(test) == "MyDashboardActionsTest: test searching by columns":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
                , "No OTP","'What's new' popup isn't displayed"
        ...
        if self.get_test_pretty_name_new(test) == "MyDashboardActionsTest: test sorting columns":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
                , "No OTP","'What's new' popup isn't displayed","The my dashboard  module was opened"
                ,"Select show all tab"
                ,"Get type"
                ,"Sort by type"
                ,"Get type"
        ...
        if self.get_test_pretty_name_new(test) == "MyDashboardActionsTest: test sms icon":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
        ...
        if self.get_test_pretty_name_new(test) == "MyDashboardActionsTest: test email icon":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
                ...
                ,"Enter subject mailSUBJECT_TASK_MAIL5332255"
                ,"Enter body mail"
                ,"Enter cc mailjonathan.albalak@pandats.com"
                ,"Enter body mail"
                ,"Click Send"]

        if self.get_test_pretty_name_new(test) == "MyDashboardActionsTest: test edit event my dashboard":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
                ...
                ,"The date  is set 2019-04-06"
                ,"The time  is set 18:27:27"
        ...
        if self.get_test_pretty_name_new(test) == "LeadModuleTest: test check email popup":
            step_suit = ["Open CRM"
                ...
                , "Get first lead email"
                , "Click first lead email"
                , "Get lead email pop up"
                , "Enter subject mail"
                , "Enter body mail"
                , "Click save"
                ...
                , "The search button was clicked "
                , "Open lead personal details"
                , "Open lead email section"
                , "Open lead email section"]
        ...
        if self.get_test_pretty_name_new(test) == "LeadModuleTest: fill questioner new client":
            step_suit = ["Open CRM"
                ...
                ,"The field found is : Test Clients"
                ,"Click the selected filter"
                ,"Setting  the user's email in the email field  is : pandaqa+20190306151330@pandats.com"
                ,"Click the search button"
                ,"Click user email: pandaqa+20190306151330@pandats.com"
                ,"Click fill questionnaire btn"
                ,"Select status: Self-employed"
                ,"Press check box industry: Financial services, banking, accounting"
                ,"Press radio button: Yes"
                ,"Press check box sourse: Funds from Savings and investments"
                ,"Press check box sourse: Wealth from Savings and investments"
                ,"Select income: €12,001 - €100,000"
                ,"Select income: €500,001 - €1,000,000"
                ,"Select purpose: Speculative trading"
                ,"Select estimate year: €50,001 - €100,000"
                ,"Select incoming funds: European Bank or Credit/Debit Card or Digital Electronic Wallet"
                ,"Press click knowledge and experience"
                ,"Select level education: High school/Bachelor degree or equivalent"
                ,"Select How long have you been investing in the financial markets?: 1-3 years"
                ,"Select When was your last trade carried out?: 3-6 months"
                ,"Press Traded in Stocks/Shares, Indices, Commodities"
                ,"Select What is your level of experience in derivative products such as CFD's on Stocks/Shares, Indices, Commodities, FX Pairs, and Cryptocurrencies?6-12 months"
                ,"Select What is your annual average trade size (volume) of your past 40 leveraged transactions? : More than €5,000 in Stocks/Cryptos and/or €15,000 in Forex/Commodities"
                ,"Select When trading with leverage, which one of the following applies?: Trading may increase profits or losses"
                ,"Select How might a positive financial report related to Apple affect the company's CFD price?: Not be affected"
                ,"Select If Facebook shares traded on the NASDAQ exchange drops significantly, the price of your Facebook CFD would…: Move in the opposite direction"
                ,"Select With an initial deposit of €1,000 and 1:100 leverage, what would your buying power be? : €150,000"
                ,"Press Risk tolerance"
                ,"Select How would you feel if you lost your deposited capital as a result of trading? : I would be upset for a while but the loss will not affect my financial situation to a large extent"
                ,"Select What are your investment objectives? : "
                ,"Press FATCA & CRS information"
                ,"Select What are your investment objectives? : Albania"
                ,"Enter tin : 213123123"
                ,"Are you a citizen of the United States or a resident for tax purposes?: No"
