    ...
    def write_test_results(self, brands, tests, results):
        ...
        for test in tests:
            ...
            for step in step_suit:
                if step == "test create filter clients module" or step == "test create filter documents module" \
                        or step ==  "test create filter leads module" or step ==  "test create filter help desk" or step ==  "test create filter trading account module" \
                        or step == "test searching lead modules" or step == "test create lead" or step == "test edit lead"\
                        or step == "test perform convert lead" or step == "test make searching client module" or step == "test add interaction" \
                        or step == "test interaction search" or step == "test add event" or step == "test edit event" \
                       or step == "test crm open trading account" or step == "test check client password crm" or step == " test check mt4 password crm" \
                       or step == "test change client password from crm" or step == "test change mt4 password from crm" or step == "test make deposit crm" \
                       or step == "test make deposit for client crm" or step == "test make credit in from crm" or step == "test crm edit trading account" \
                       or step == "test check add tasks calendar view" or step == "test check day tab" or step == "test check month tab" \
                       or step == "test check week tab" or step == "test check all tab from financial transactions" or step == "test check searching by column" \
                       or step == "test check search via button":
