...
class ExcelWriter:
    ...
    def steps_for_test(self, test):
        ...
        if self.get_test_pretty_name_new(test) == "TransferBetweenTa: test transfer between ta":
            step_suit = ["Open CRM"
                , "Enter Username"
                , "Enter Password"
                , "Click Login"
                ...
                , "Click the search button"
                , "Click user email  "
                , "Open mt actions: Create MT account"
                , "Trading account server was selected  real"
                ...
                , "Open the trading account tab"
                , "Get first ta number"
                , "Get second ta number"
                , "Get first account balance"
                , "Get second account balance"
                , "Calculate expected balance"
                , "Perform scroll up"
                , "Open MT4: Transfer between accounts"
                , "The first account selected"
                , "The second account selected"
                , "The amount of transfer between ta module was set"
                , "The  description of transfer between ta  module was set in the description field"
                , "The create withdraw button of transfer between ta module was clicked"
                , "Returns a confirmation message"
                , "Click OK"
                , "Scroll to trading account section"
                , "Balance of trading account is verified"]
