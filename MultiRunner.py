        ...
        for filename in glob.glob(Config.file_path_2):
            if "test_results" in filename:
                ...
                format2 = workbook.add_format({'bg_color': '#C4D79B',
                                               'font_color': '#000000'})
                worksheet.conditional_format(0, 0, 282, 200, {'type': 'text',
                                                              'criteria': 'beginsWith',
                                                              'value': 'PASS',
                                                              'format': format2})
                ...
                worksheet.set_row(127, None, None, {'level': 1, 'hidden': True})
                for i in range(128, 141):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(142, None, None, {'level': 1, 'hidden': True})
                for i in range(143, 159):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(160, None, None, {'level': 1, 'hidden': True})
                for i in range(161, 180):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(181, None, None, {'level': 1, 'hidden': True})
                for i in range(182, 194):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(195, None, None, {'level': 1, 'hidden': True})
                for i in range(196, 208):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(209, None, None, {'level': 1, 'hidden': True})
                for i in range(210, 226):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(227, None, None, {'level': 1, 'hidden': True})
                for i in range(228, 238):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(239, None, None, {'level': 1, 'hidden': True})
                for i in range(240, 249):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(250, None, None, {'level': 1, 'hidden': True})
                for i in range(251, 272):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})

                worksheet.set_row(273, None, None, {'level': 1, 'hidden': True})
                for i in range(274, 282):
                    worksheet.set_row(i, None, None, {'level': 2, 'hidden': True})
